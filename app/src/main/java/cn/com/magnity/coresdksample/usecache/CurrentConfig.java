...
public class CurrentConfig {
    ...
    private CurrentSettingData updateData() {
        ...
        currentSettingData.setCamera_explore(PreferencesUtils.getString(WebConfig.CAMERA_EXPLORE,"1"));
        currentSettingData.setDistance(PreferencesUtils.getString(WebConfig.DISTANCE,"1.2"));
        currentSettingData.setError_voice(PreferencesUtils.getString(WebConfig.ERROR_VOICE,"10"));
        currentSettingData.setFFC_compensation_parameter(PreferencesUtils.getString(WebConfig.FFC_COMPENSATION_PARAMETER,"0"));
        currentSettingData.setFFC_calibration_parameter(PreferencesUtils.getString(WebConfig.FFC_CALIBRATION_PARAMETER,"0"));
        ...
        currentSettingData.setLineUp(PreferencesUtils.getString(WebConfig.LINEUP,"45"));
        currentSettingData.setLineLeft(PreferencesUtils.getString(WebConfig.LINELEFT,"114"));
        currentSettingData.setLineDown(PreferencesUtils.getString(WebConfig.LINEDWON,"448"));
        currentSettingData.setLineRight(PreferencesUtils.getString(WebConfig.LINERIGHT,"576"));
